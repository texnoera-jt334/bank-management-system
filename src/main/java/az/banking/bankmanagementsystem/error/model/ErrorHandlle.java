...
import az.banking.bankmanagementsystem.error.exception.TransactionLimitExceededException;
...
public class ErrorHandlle extends ResponseEntityExceptionHandler {
    private final MessageSource messageSource;

    public ErrorHandlle(MessageSource messageSource) {
    ...
    //Turxan mellim verdiyi qayda


    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(TransactionLimitExceededException.class)
    public ResponseEntity<ErrorResponse> handleUserNotFoundException(TransactionLimitExceededException ex,
                                                                     Locale locale) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ErrorResponse(HttpStatus.NOT_FOUND.value(),
                        messageSource.getMessage("Transaction.Limit.Exception", null, locale)));
